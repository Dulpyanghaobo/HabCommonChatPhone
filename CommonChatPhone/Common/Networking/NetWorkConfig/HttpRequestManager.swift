...
extension ObservableType where Element == Response {
    ...
    public func filterSuccess(showHud: Bool) -> Observable<Element> {
        
        return flatMapLatest { (response) -> Observable<Element> in
    ...
    public func filterBaiduSuccess() -> Observable<Element> {
    ...
    fileprivate func loginInvalid() {
        ...
        DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 1.0) {
            ...
            HABUserManager.shared.clearChaches()
        }
    }
}
